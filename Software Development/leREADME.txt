...
Linkbroker: linkbroker_software_support.c
...
To reset license uses, simply erase all content in usedlicenses.
...
The DEVexample file is merely a test program. It requires no special compilation options.
 gcc -c DEVexample will give you the .o file to send through to linkbroker.
