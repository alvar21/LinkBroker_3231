...
//
//  developer.c
//  command line arguments: 'software component' 'number of softwarehouses'  //TODO define what exactly we need
//
// 
...
void main()
{
    ...
    char    *str;
    char    buf [4096];
    char    hello[80]; //TODO message to send to server, change
    ...
    fgets (hello, 80, stdin); //TODO change to name of software file
