...
/*void LinkBrokering() //Where LinkBroker contacts both SoftwareHouses and does everything before sending back to developer
{
    int     err;
    ...
    const char      *s_ipaddr = "127.0.0.1"; //TODO change
...
void main()
{
    ...
    //Call LinkBrokering method here
